...
const SYSTEM_GROUPS: Record<string, string[]> = {
  'Renal Profile': ['CREAT', 'UREA', 'BUN', 'EGFR', 'SODIUM', 'NA', 'POTASSIUM', 'K', 'CHLORIDE', 'CL', 'BICARBONATE', 'HCO3', 'CO2'],
  'Liver Function': ['ALT', 'SGPT', 'AST', 'SGOT', 'GGT', 'ALP', 'ALK PHOS', 'BILIRUBIN', 'BILI', 'TBILI', 'DBILI', 'TOTAL PROTEIN', 'TP', 'ALBUMIN', 'ALB', 'GLOBULIN'],
  'Bone & Minerals': ['CALCIUM', 'CA', 'ADJ CA', 'PHOSPHATE', 'PHOS', 'PO4', 'MAGNESIUM', 'MG', 'VITAMIN D', 'VIT D', '25-OH VIT D', 'PTH'],
  ...
  'Lipid Panel': ['CHOLESTEROL', 'CHOL', 'TOTAL CHOL', 'LDL', 'HDL', 'TRIGLYCERIDES', 'TG', 'VLDL'],
  'Thyroid': ['TSH', 'FT4', 'FREE T4', 'FT3', 'FREE T3', 'T4', 'T3'],
