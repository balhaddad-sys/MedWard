  ...
  try {
    const result = await runTransaction(db, async (transaction) => {
      ...
      const onCallEntry: OnCallListEntry = {
        ...
        addedBy: userId,
        clerkingNoteId: noteId,
        presentingComplaint: note.presentingComplaint || undefined,
        workingDiagnosis: note.workingDiagnosis || undefined,
        notes: note.presentingComplaint || undefined,
        escalationFlags,
        isActive: true,
